	...
	texts: {
		...
		modals: {
			...
			bootLocalNode: {
				...
				warningStatement: 'Vous avez activé le démarage automatique et vous utiliser un noed distant. {3}}.<br/><br/>Démarrer un nœud à distance est présentement impossible à partir de NCC.',
